...
import matheusgomes.cursoandroid.olx.com.databinding.ActivityPrincipalBinding;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                matheusgomes.cursoandroid.olx.com.R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow)
